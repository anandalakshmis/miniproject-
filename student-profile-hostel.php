...
error_reporting(0);
	...
	$due = 0;
	$query = mysql_query("select * from library_due where roll_number='".$_SESSION['roll']."'",$connection);
  ...
  <body>
	...
	<div align="center">
		<ul class="nav nav-tabs nav-justified">
		  <li role="presentation"><a href="student-profile.php">lab Due</a></li>
		  <li role="presentation" class="active"><a href="#">library Due</a></li>
		  <li role="presentation"><a href="student-profile-other.php">Office Due</a></li>
		</ul>
	</div>
